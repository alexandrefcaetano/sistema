                                        ...
                                        <div class="d-flex justify-content-center">
                                            <ul class="pagination">
                                                ...
                                                <li class="page-item {{ $users->onFirstPage() ? 'disabled' : '' }}">
                                                    <a class="page-link"
                                                       href="{{ $users->url(1) }}&per_page={{ $perPage }}">Primeira</a>
                                                </li>

                                                <!-- Previous -->
                                                <li class="page-item {{ $users->onFirstPage() ? 'disabled' : '' }}">
                                                    <a class="page-link"
                                                       href="{{ $users->previousPageUrl() }}&per_page={{ $perPage }}">Anterior</a>
                                                </li>
                                                ...
                                                <li class="page-item {{ $users->currentPage() == $users->lastPage() ? 'disabled' : '' }}">
                                                    <a class="page-link"
                                                       href="{{ $users->nextPageUrl() }}&per_page={{ $perPage }}">Próxima</a>
                                                </li>

                                                <!-- Last -->
                                                <li class="page-item {{ $users->currentPage() == $users->lastPage() ? 'disabled' : '' }}">
                                                    <a class="page-link"
                                                       href="{{ $users->url($users->lastPage()) }}&per_page={{ $perPage }}">Última</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
