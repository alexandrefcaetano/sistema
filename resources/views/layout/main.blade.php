                            ...
                            <form>
                                ...
                                <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url({{ asset('assets/media/misc/bg-1.jpg')}})">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active show" data-toggle="tab" href="" role="tab" aria-selected="true"></a>
                                        </li>
                                    </ul>
                                </div>
                            </form>
...
{{--<script src="{{ asset('assets/app/custom/general/crud/datatables/data-sources/html.js')}}" type="text/javascript"></script>--}}
{{--<script src="{{ asset('assets/app/custom/general/crud/datatables/data-sources/html.js')}}" type="text/javascript"></script>--}}
